...
class Memory(object):
    ...
    def get_recent_state(self, current_observation):
        # we ensure that an experience never spans multiple episodes
        state = [current_observation]
        idx = len(self.recent_observations) - 1  # basically last element inserted
...
class SequentialMemory(Memory):
    def __init__(self, limit, **kwargs):
        ...
        # do not use deque to implement the memory, it is slow on random access. Use ring buffer above
